...
public class ConfiguracionFirma {
    ...
    private PosicionGrafo posicionGrafo;
    ...
    public PosicionGrafo getPosicionGrafo() {
        return posicionGrafo;
    }

    public void setPosicionGrafo(PosicionGrafo posicionGrafo) {
    ...
    public static class PosicionGrafo {
