...
public interface EjecutarCotejoUseCase {
    ResultadoEjecucionCotejo ejecutar(SolicitudCotejo solicitud);
    
    public static class SolicitudCotejo {
    ...
    public static class ResultadoEjecucionCotejo {
        private String ejecucionId;
        private String estadoProceso;
        private String mensajeProceso;
        private Ejecucion ejecucion;

        public ResultadoEjecucionCotejo() {
        }

        public ResultadoEjecucionCotejo(String ejecucionId, String estadoProceso, String mensajeProceso, Ejecucion ejecucion) {
