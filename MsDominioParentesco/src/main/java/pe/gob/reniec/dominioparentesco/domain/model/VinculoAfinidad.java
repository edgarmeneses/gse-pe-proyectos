...
/**
 * Entity - Representa un vínculo de afinidad encontrado en el análisis.
 */
public class VinculoAfinidad {
    ...
    private final ConyugeIntermedio conyugeIntermedio;
    ...
    private VinculoAfinidad(Builder builder) {
        ...
        this.conyugeIntermedio = builder.conyugeIntermedio;
    ...
    public ConyugeIntermedio getConyugeIntermedio() { return conyugeIntermedio; }
    ...
    public boolean equals(Object o) {
        ...
        VinculoAfinidad that = (VinculoAfinidad) o;
    ...
    public static class Builder {
        ...
        public Builder conyugeIntermedio(ConyugeIntermedio conyugeIntermedio) { this.conyugeIntermedio = conyugeIntermedio; return this; }
        ...
        public VinculoAfinidad build() {
            return new VinculoAfinidad(this);
        }
    }
}
