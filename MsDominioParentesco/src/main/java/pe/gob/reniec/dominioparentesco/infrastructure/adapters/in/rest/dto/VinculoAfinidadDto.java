...
/**
 * DTO para vínculos de parentesco por afinidad.
 */
public class VinculoAfinidadDto {
    ...
    private ConyugeIntermedioDto conyugeIntermedio;
    ...
    public ConyugeIntermedioDto getConyugeIntermedio() { return conyugeIntermedio; }
    public void setConyugeIntermedio(ConyugeIntermedioDto conyugeIntermedio) { this.conyugeIntermedio = conyugeIntermedio; }
