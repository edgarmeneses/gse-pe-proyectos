...
public class RelacionParentesco {
    ...
    public RelacionParentesco() {
    }

    public RelacionParentesco(Long idRelacion, String idAnalisis, String idCiudadanoOrigen, String idCiudadanoDestino,
                              String codigoTipoParentesco, Integer gradoParentesco, String idActaSustento,
                              String idDocumentoSustento, LocalDate fechaInicioVigencia, LocalDateTime fechaRegistro,
                              String observacion, Boolean vigente) {
