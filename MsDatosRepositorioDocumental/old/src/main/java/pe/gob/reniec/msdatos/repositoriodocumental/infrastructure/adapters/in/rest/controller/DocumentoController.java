...
public class DocumentoController {
    ...
    public ListarDocumentosResponseDto listar(String queryParam1, String queryParam2, String queryParam3,
        ...
        return DocumentoDtoMapper.toListarResponseDto(documentos, page, size);
    }

    public ConsultarDocumentoPorDniResponseDto consultarPorDni(String dni, String tipoDocumento, String fechaDesde, String fechaHasta,
        ...
        return DocumentoDtoMapper.toConsultarPorDniResponseDto(documentos, dni, page, size);
    }
}
